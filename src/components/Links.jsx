  ...
  return (
    <>
      ...
      <ul className="link-list-big">
        ...
        <li>
          <Link onClick={handleClickQuiz} to="/Quiz">
            Quiz
          </Link>
        </li>
    ...
    <div className="popup-menu">
      <ul className="link-list-small">
        ...
        <li>
          ...
          >
            {" "}
            <img className="menu-logos" src={quizLogo} alt="Quiz" />
            Quiz
          </Link>
        </li>

        <li>
          <Link to="/HowToPlay" onClick={() => setShow(!show)}>
            <img className="menu-logos" src={howTo} alt="How to" />
            How to play
          </Link>
        </li>
      </ul>
